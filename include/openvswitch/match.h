...
void match_set_any_nix_lse(struct match *, int idx);
void match_set_nix_lse(struct match *, int idx, ovs_be64);
void match_set_any_nix_vec(struct match *, int idx);
void match_set_nix_vec(struct match *, int idx, ovs_be32);
void match_set_any_nix_cur(struct match *, int idx);
void match_set_nix_cur(struct match *, int idx, uint8_t);
void match_set_any_nix_tot(struct match *, int idx);
void match_set_nix_tot(struct match *, int idx, uint8_t);
void match_set_any_nix_preveth(struct match *, int idx);
void match_set_nix_preveth(struct match *, int idx, ovs_be16);
void match_set_tp_src(struct match *, ovs_be16);
void match_set_mpls_lse(struct match *, int idx, ovs_be32 lse);
void match_set_nix_lse(struct match *, int idx, ovs_be64 lse);
